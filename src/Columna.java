...
public class Columna<T> {
    ...
    // Obtiene el valor de una celda en una fila específica. Si la fila es inválida, lanza una excepción
    ...
    // Obtiene la celda completa en una fila específica. Si la fila es inválida, lanza una excepción
    ...
    // Establece el valor de una celda en una fila específica. Si la fila es inválida o
    // el valor no es del tipo correcto, lanza una excepción.
    ...
    // Agrega una nueva celda al final de la columna. Si el valor no es del tipo correcto, lanza una excepción.
    ...
    // Metodo para verificar si un valor es NA.
    public static boolean esNA(Object valor) {
        return valor == null || valor.equals("NA");
    }

    // Metodo para contar NAs en esta columna específica.
    ...
    // Devuelve una nueva columna: concatena las celdas de esta columna con las de otra.
    ...
    // Verifica si el valor es válido según el tipo de dato de la columna.
